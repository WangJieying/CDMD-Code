...
void setConfig(Config c) {
    ...
    MSIL_SELECTION = c.exists("layer_selection") ? c.pString("layer_selection") == "cumulative" : false;
...
vector<std::pair<int, skel_tree_t*>>* execute_skeleton_pipeline(FIELD<float>* im, int *firstLayer) {
    ...
    vector<std::pair<int, skel_tree_t*>>* forest = il->computeSkeletons(firstLayer);
